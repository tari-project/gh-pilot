...
pub struct AlertInstance {
    #[doc = "Identifies the configuration under which the analysis was executed. For example, in GitHub Actions this \
    ...
    #[doc = "Identifies the variable values associated with the environment in which the analysis that generated this \
...
/// A deployment to a repository environment. This will only be populated if the check run was created by a GitHub
/// Actions workflow job that references an environment.
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(deny_unknown_fields)]
...
pub struct CodeScanningAlertAppearedInBranch {
    ...
    #[doc = "The commit SHA of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, \
             the event was triggered by the `sender` and this value will be empty."]
    pub commit_oid: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub installation: Option<InstallationLite>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub organization: Option<Organization>,
    #[doc = "The Git reference of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, \
             the event was triggered by the `sender` and this value will be empty."]
    #[serde(rename = "ref")]
    pub ref_: String,
    pub repository: Repository,
...
pub enum CodeScanningAlertEvent {
    ...
    AppearedInBranch {
        ...
        #[doc = "The commit SHA of the code scanning alert. When the action is `reopened_by_user` or \
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        organization: Option<Organization>,
        #[doc = "The Git reference of the code scanning alert. When the action is `reopened_by_user` or \
                 `closed_by_user`, the event was triggered by the `sender` and this value will be empty."]
        #[serde(rename = "ref")]
        ref_: String,
        repository: Repository,
...
pub enum MemberEvent {
    #[doc = "member added event\n\nActivity related to repository collaborators. The type of activity is specified in \
             the action property."]
    #[serde(rename = "added")]
    Added {
        #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SponsorshipPendingCancellation {
    ...
    #[doc = "The `pending_cancellation` and `pending_tier_change` event types will include the date the cancellation \
             or tier change will take effect."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub enum SponsorshipEvent {
    ...
    PendingCancellation {
        #[doc = "The `pending_cancellation` and `pending_tier_change` event types will include the date the \
...
pub struct StarCreated {
    ...
    pub repository: Repository,
    pub sender: User,
    #[doc = "The time the star was created. This is a timestamp in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`. Will be \
             `null` for the `deleted` action."]
...
pub enum StarEvent {
    ...
    Created {
        ...
        repository: Repository,
        sender: User,
        #[doc = "The time the star was created. This is a timestamp in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`. Will \
                 be `null` for the `deleted` action."]
        starred_at: String,
    },
    /// star deleted event
    #[serde(rename = "deleted")]
...
pub struct StatusEvent {
    ...
    #[doc = "An array of branch objects containing the status' SHA. Each branch contains the given SHA, but the SHA \
...
impl ToString for CheckRunCompletedCheckRunCheckSuiteConclusion {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckRunCompletedCheckRunCheckSuiteConclusion::ActionRequired => "action_required".to_string(),
...
pub struct CheckRunCompletedCheckRunCheckSuite {
    ...
    #[doc = "An array of pull requests that match this check suite. A pull request matches a check suite if they have \
             the same `head_sha` and `head_branch`. When the check suite's `head_branch` is in a forked repository it \
             will be `null` and the `pull_requests` array will be empty."]
...
/// The result of the completed check run. Can be one of `success`, `failure`, `neutral`, `cancelled`, `timed_out`,
...
pub struct CheckRunCompletedCheckRun {
    ...
    #[doc = "The time the check completed. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) \
             format: `YYYY-MM-DDTHH:MM:SSZ`."]
    pub completed_at: String,
    #[doc = "The result of the completed check run. Can be one of `success`, `failure`, `neutral`, `cancelled`, \
             `timed_out`, `action_required` or `stale`. This value will be `null` until the check run has completed."]
...
impl ToString for CheckRunRequestedActionCheckRunCheckSuiteConclusion {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckRunRequestedActionCheckRunCheckSuiteConclusion::Cancelled => "cancelled".to_string(),
            CheckRunRequestedActionCheckRunCheckSuiteConclusion::TimedOut => "timed_out".to_string(),
            CheckRunRequestedActionCheckRunCheckSuiteConclusion::ActionRequired => "action_required".to_string(),
...
impl ToString for CheckRunRequestedActionCheckRunCheckSuiteStatus {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckRunRequestedActionCheckRunCheckSuiteStatus::InProgress => "in_progress".to_string(),
...
impl ToString for CheckRunRequestedActionCheckRunConclusion {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckRunRequestedActionCheckRunConclusion::ActionRequired => "action_required".to_string(),
...
impl ToString for CheckRunRerequestedCheckRunCheckSuiteConclusion {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckRunRerequestedCheckRunCheckSuiteConclusion::ActionRequired => "action_required".to_string(),
...
impl ToString for CheckSuiteCompletedCheckSuiteConclusion {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckSuiteCompletedCheckSuiteConclusion::ActionRequired => "action_required".to_string(),
...
pub struct CheckSuiteCompletedCheckSuite {
    ...
    #[doc = "The summary conclusion for all check runs that are part of the check suite. Can be one of `success`, \
             `failure`, `neutral`, `cancelled`, `timed_out`, `action_required` or `stale`. This value will be `null` \
    ...
    #[doc = "An array of pull requests that match this check suite. A pull request matches a check suite if they have \
             ...
             will be `null` and the `pull_requests` array will be empty."]
    pub pull_requests: Vec<CheckRunPullRequest>,
    #[doc = "The summary status for all check runs that are part of the check suite. Can be `requested`, \
...
impl ToString for CheckSuiteRequestedCheckSuiteConclusion {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckSuiteRequestedCheckSuiteConclusion::ActionRequired => "action_required".to_string(),
...
impl ToString for CheckSuiteRerequestedCheckSuiteConclusion {
    fn to_string(&self) -> String {
        match *self {
            ...
            CheckSuiteRerequestedCheckSuiteConclusion::ActionRequired => "action_required".to_string(),
...
impl ToString for CodeScanningAlertAppearedInBranchAction {
    fn to_string(&self) -> String {
        match *self {
            CodeScanningAlertAppearedInBranchAction::AppearedInBranch => "appeared_in_branch".to_string(),
        }
    }
}
...
impl ToString for CodeScanningAlertAppearedInBranchAlertDismissedReason {
    fn to_string(&self) -> String {
        match *self {
            CodeScanningAlertAppearedInBranchAlertDismissedReason::FalsePositive => "false positive".to_string(),
            CodeScanningAlertAppearedInBranchAlertDismissedReason::WontFix => "won't fix".to_string(),
            CodeScanningAlertAppearedInBranchAlertDismissedReason::UsedInTests => "used in tests".to_string(),
        }
    }
}
...
pub struct CodeScanningAlertAppearedInBranchAlert {
    ...
    #[doc = "The reason for dismissing or closing the alert. Can be one of: `false positive`, `won't fix`, and `used \
             in tests`."]
...
impl ToString for CodeScanningAlertClosedByUserAlertDismissedReason {
    fn to_string(&self) -> String {
        match *self {
            CodeScanningAlertClosedByUserAlertDismissedReason::FalsePositive => "false positive".to_string(),
            CodeScanningAlertClosedByUserAlertDismissedReason::WontFix => "won't fix".to_string(),
            CodeScanningAlertClosedByUserAlertDismissedReason::UsedInTests => "used in tests".to_string(),
        }
    }
}
...
impl ToString for CodeScanningAlertFixedAlertDismissedReason {
    fn to_string(&self) -> String {
        match *self {
            CodeScanningAlertFixedAlertDismissedReason::FalsePositive => "false positive".to_string(),
...
impl ToString for InstallationNewPermissionsAcceptedAction {
    fn to_string(&self) -> String {
        match *self {
            InstallationNewPermissionsAcceptedAction::NewPermissionsAccepted => "new_permissions_accepted".to_string(),
        }
    }
}
...
/// The modified webhook. This will contain different keys based on the type of webhook it is: repository, organization,
...
impl ToString for PullRequestAutoMergeDisabledAction {
    fn to_string(&self) -> String {
        match *self {
            PullRequestAutoMergeDisabledAction::AutoMergeDisabled => "auto_merge_disabled".to_string(),
        }
    }
}
...
impl ToString for PullRequestReviewRequestRemovedAction {
    fn to_string(&self) -> String {
        match *self {
            PullRequestReviewRequestRemovedAction::ReviewRequestRemoved => "review_request_removed".to_string(),
        }
    }
}
...
fn pull_request_review_comment_created_comment_start_side() -> Option<PullRequestReviewCommentCreatedCommentStartSide> {
...
fn pull_request_review_comment_deleted_comment_start_side() -> Option<PullRequestReviewCommentDeletedCommentStartSide> {
...
fn pull_request_review_comment_edited_comment_start_side() -> Option<PullRequestReviewCommentEditedCommentStartSide> {
...
impl ToString for SecretScanningAlertResolvedAlertResolution {
    fn to_string(&self) -> String {
        match *self {
            SecretScanningAlertResolvedAlertResolution::FalsePositive => "false_positive".to_string(),
...
pub struct SecurityAdvisoryPerformedSecurityAdvisoryVulnerabilitiesItem {
    pub first_patched_version: Option<SecurityAdvisoryPerformedSecurityAdvisoryVulnerabilitiesItemFirstPatchedVersion>,
...
pub struct SecurityAdvisoryPublishedSecurityAdvisoryVulnerabilitiesItem {
    pub first_patched_version: Option<SecurityAdvisoryPublishedSecurityAdvisoryVulnerabilitiesItemFirstPatchedVersion>,
...
pub struct SecurityAdvisoryUpdatedSecurityAdvisoryVulnerabilitiesItem {
    pub first_patched_version: Option<SecurityAdvisoryUpdatedSecurityAdvisoryVulnerabilitiesItemFirstPatchedVersion>,
...
pub struct SponsorshipEditedChangesPrivacyLevel {
    #[doc = "The `edited` event types include the details about the change when someone edits a sponsorship to change \
             the privacy."]
    pub from: String,
}
...
impl ToString for SponsorshipPendingCancellationAction {
    fn to_string(&self) -> String {
        match *self {
            SponsorshipPendingCancellationAction::PendingCancellation => "pending_cancellation".to_string(),
        }
    }
}
...
impl ToString for SponsorshipPendingTierChangeAction {
    fn to_string(&self) -> String {
        match *self {
            SponsorshipPendingTierChangeAction::PendingTierChange => "pending_tier_change".to_string(),
        }
    }
}
...
impl ToString for StatusEventCommitCommitVerificationReason {
    fn to_string(&self) -> String {
        match *self {
            ...
            StatusEventCommitCommitVerificationReason::GpgverifyUnavailable => "gpgverify_unavailable".to_string(),
            StatusEventCommitCommitVerificationReason::Unsigned => "unsigned".to_string(),
            StatusEventCommitCommitVerificationReason::UnknownSignatureType => "unknown_signature_type".to_string(),
            ...
            StatusEventCommitCommitVerificationReason::MalformedSignature => "malformed_signature".to_string(),
...
impl ToString for TeamRemovedFromRepositoryAction {
    fn to_string(&self) -> String {
        match *self {
            TeamRemovedFromRepositoryAction::RemovedFromRepository => "removed_from_repository".to_string(),
        }
    }
}
